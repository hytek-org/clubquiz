    ...
    <div>
        <div class="h-32 sm:h-44 md:h-10  -mt-4 md:hidden flex justify-between">
            <div class="bg-gradient-to-r from-blue-500/80 via-blue-600 to-blue-900 w-1/2 h-full rounded-ee-full ">
                <h2 class="text-[2rem] sm:text-[4rem] font-medium pl-4 pt-10 text-white">Forgot</h2>
            </div>
            <div class="pr-5 mt-2 ">
                <a href="/">
        ...
        <div class="hidden md:block">
            <h2 class="text-[3rem] font-medium pt-10 pl-8 text-black">Forgot your password?</h2>
        </div>
        <div class="mt-10 px-4 sm:px-10 ">
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="flex items-center md:justify-end mt-4">                   
                    <button type="submit"
                        class=" w-full md:w-auto ml-4 justify-center px-4 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:shadow-outline focus:outline-none">
