...
@section('title')
401 Unauthorized || {{config('app.name','ClubQuiz')}}
@endsection
@section('message')
<div class="grid h-screen place-content-center bg-white px-4">
    <h1
        ...
        401 Unauthorized </h1>
    <h5 class="text-xl font-poppins font-bold dark:text-white text-center">Oops! You are not authorized to access this page.</h5>
