...
@section('title')
403 Access Denied || {{config('app.name','ClubQuiz')}}
@endsection
@section('message')
<div class="grid h-screen place-content-center bg-white px-4">
    ...
    <h5 class="text-xl font-poppins font-bold dark:text-white text-center">Oops! You don't have permission to access this page.</h5>
