...
@section('title')
419 Page Expired || {{config('app.name','ClubQuiz')}}
@endsection
@section('message')
<div class="grid h-screen place-content-center bg-white px-4">
    <h1
        ...
        419 Page Expired </h1>
    <h5 class="text-xl font-poppins font-bold dark:text-white text-center">Sorry, the page has expired. Please refresh and try again.</h5>
