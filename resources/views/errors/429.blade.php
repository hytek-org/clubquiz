...
@section('title')
429 Too Many Requests || {{config('app.name','ClubQuiz')}}
@endsection
@section('message')
<div class="grid h-screen place-content-center bg-white px-4">
    ...
    <h5 class="text-xl font-poppins font-bold dark:text-white text-center">We're sorry, but you have exceeded the maximum number of requests allowed.</h5>
