...
@section('title')
500 - Internal Server Error || {{config('app.name','ClubQuiz')}}
@endsection
@section('message')
<div class="grid h-screen place-content-center bg-white px-4">
    ...
    <h5 class="text-xl font-poppins font-bold dark:text-white text-center">Oops! Something went wrong on our end. We apologize for the inconvenience.</h5>
