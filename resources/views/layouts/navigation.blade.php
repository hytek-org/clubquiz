<nav x-data="{ open: false }" class="bg-[#070F2B] border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <x-application-logo class="block h-9 w-auto fil-current" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 gap-4">
                @admin
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-400 bg-[#1B1A55] hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                <div>Create</div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t bg-[#081233] border-gray-200">
            @auth
                <div class="px-4">
                ...
                <div class="mt-3 space-y-1">
                    <div class="gird grid-cols-1  border-b-[2px] border-gray-800">
                        <div class="">
                            <x-responsive-nav-link :href="route('leaderboard')" :active="request()->routeIs('leaderboard')" class="hover:text-[black]">
                                Leaderboard
                            </x-responsive-nav-link>
                        </div>

                        <div class="mb-[10px] hover:bg-slate-100">
