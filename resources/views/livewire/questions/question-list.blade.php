    ...
    <x-slot name="header">
        <div class=" py-10  md:px-4 leading-6 ">
            <h1 class="text-5xl sm:text-7xl font-bold "> <span class="text-7xl lg:text-9xl text-[#4247d1]">V</span>iew All
                Questions</h1>
            <p class="text-gray-800 pl-4 md:pl-8">Explore a wide variety of quiz questions on ClubQuiz.</p>
        </div>
    </x-slot>
    <x-slot name="sidebar">
                        ...
                        <table class="min-w-full border divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-gray-50 px-6 py-3 text-left">
                                        <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500">Question Category</span>
                                    </th>
